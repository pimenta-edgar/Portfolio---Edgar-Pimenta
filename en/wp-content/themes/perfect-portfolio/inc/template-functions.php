                            ...
                            <div class="about-author">
                                ...
                                <div class="author-info-wrap">
                                    <?php 
                                        ...
                                        echo '<h1 class="name">' . esc_html( $author_title ) . '</h1>';
...
add_action( 'perfect_portfolio_after_portfolio_content', 'perfect_portfolio_comment', 20 );
    ...
    <div class="bottom-footer">
		<div class="tc-wrapper">
            <div class="copyright">           
                ...
                esc_html_e( 'Edgar Pimenta | Marketing Digital & Design de Comunicação ', 'perfect-portfolio' );
